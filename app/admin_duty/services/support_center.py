...
RUNBOOK_CATALOG = MappingProxyType(
    {
        "systemd-service": PublicRunbook(
            ...
            steps=(
                ...
                "Dokumentację wdrożenia znajdziesz w README.md w katalogu aplikacji pod /opt.",
                "Po edycji jednostki przez nano wykonaj systemctl daemon-reload, restart i ponownie potwierdź status.",
            ),
