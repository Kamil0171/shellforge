# Źródła projektu ShellForge

Ten dokument zawiera główne źródła wykorzystywane podczas budowy aplikacji ShellForge i przygotowywania materiałów edukacyjnych. Źródła dotyczące pomysłów, które nie są częścią aktualnej implementacji, zostały oddzielone na końcu dokumentu.
...
## Linux i administracja systemem
...
## Źródła dla przyszłych obszarów
